...
with st.container():
    with st.sidebar:
        choose = option_menu("Water Quality", ["Home", "Project"],
            ...
            "icon": {"color": "#dab894", "font-size": "25px"}, 
            "nav-link": {"font-size": "16px", "text-align": "left", "margin":"0px", "--hover-color": "#eee"},
            "nav-link-selected": {"background-color": "#a87bed3"},
        }
        )
...
#     1. ph: pH of 1. water (0 to 14) | **_Numerik_**.
#     2. Hardness: Capacity of water to precipitate soap in mg/L | **_Numerik_**.
#     3. Solids: Total dissolved solids in ppm | **_Numerik_**.
#     4. Chloramines: Amount of Chloramines in ppm | **_Numerik_**.
#     5. Sulfate: Amount of Sulfates dissolved in mg/L | **_Numerik_**.
#     6. Conductivity: Electrical conductivity of water in μS/cm | **_Numerik_**.
#     7. Organic_carbon: Amount of organic carbon in ppm | **_Numerik_**.
#     8. Trihalomethanes: Amount of Trihalomethanes in μg/L | **_Numerik_**.
#     9. Turbidity: Measure of light emiting property of water in NTU | **_Numerik_**.
#     10. Potability: Indicates if water is safe for human consumption. Potable -1 and Not potable -0 | **_Numerik_**.
#     """)
